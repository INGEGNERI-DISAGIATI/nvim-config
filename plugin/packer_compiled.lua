...
_G.packer_plugins = {
  ["asyncrun.vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/asyncrun.vim",
    url = "https://github.com/skywind3000/asyncrun.vim"
  },
  ["asynctasks.vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/asynctasks.vim",
    url = "https://github.com/skywind3000/asynctasks.vim"
  },
  autocwd = {
    config = { "require('config.autocwd')" },
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/autocwd",
  ...
  ["hlsearch.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/hlsearch.nvim",
  ...
  ["lspkind-nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/lspkind-nvim",
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lspsaga.nvim" },
  ...
  ["telescope-symbols.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/telescope-symbols.nvim",
  ...
  ["tmux.nvim"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/tmux.nvim",
  ...
  ["vim-commentary"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/vim-commentary",
  ...
  ["vim-conflicted"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/vim-conflicted",
  ...
  ["vista.vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vista.vim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'vim-commentary', 'lspkind-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
